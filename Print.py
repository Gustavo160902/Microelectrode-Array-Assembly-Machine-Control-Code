...
def print_origin():
    ...
    time.sleep(1.0)
    move_linear_stage(x, '-', 30317.5, wait_for_stop=True, max_wait=30.0) ##27350.5 old 

    time.sleep(1.0)
    move_linear_stage(y, '-', 24800, wait_for_stop=True, max_wait=30.0)
...
def full_sequence():
    ...
    print("Full sequence complete.")import time
import math
from motor_control import (
    move_linear_stage, 
    update_speed, 
